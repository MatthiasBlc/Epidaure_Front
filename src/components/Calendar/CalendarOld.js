...
class Calendar extends Component {
  ...
  get calendar() {
    console.log("checkmycalendar", this.calendarRef.current.control)
  ...
  loadCalendarData() {
    ...
    console.log('formatCalendar', this.calendar)
  }

  // event moving
  // eventMooving() {
  //   this.onEventMoved = function (args) {
  //     this.message("Moved: " + args.e.text());
  //     console.log("heeeeeeeeeeeeeeeelllloooo");
  //   };
  ...
  render() {
    console.log("calendar", this.calendarRef)
